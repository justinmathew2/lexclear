...
export const DisclaimerBanner: React.FC = () => {
  return (
    <div className="bg-amber-950/40 border-b border-amber-500/30 backdrop-blur-md px-4 py-2.5 text-xs text-amber-200/90 flex flex-wrap items-center justify-between gap-2 shadow-inner">
